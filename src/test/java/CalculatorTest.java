...
public class CalculatorTest {
    ...
    public void testsqrt(){
        ...
        assertNotEquals("Square root of positive integer", 4, calculator.sqrt(4), DELTA);
        assertNotEquals("Square root of positive integer", 10, calculator.sqrt(25), DELTA);
    }
    @Test
    public void testlog(){
        ...
        assertNotEquals("Log of positive number", 10, calculator.log(10), DELTA);
    }
    @Test
    public void testpow(){
        assertEquals("Power of a and b where a and b are positive", 81, calculator.pow(3,4), DELTA);
        assertEquals("Power of a and b where a and b are negative", 0.25, calculator.pow(-2,-2), DELTA);
        assertEquals("Power of a and b where a is negative and b is positive", 81, calculator.pow(-3,4), DELTA);
        assertEquals("Power of a and b where a is positive and b is negative", 0.25, calculator.pow(2,-2), DELTA);
        assertNotEquals("Power of a and b where a and b are positive", 9, calculator.pow(3,4), DELTA);
    }
    @Test
    public void testfact(){
        ...
        assertNotEquals("Fatorial of a where a is positive", 25, calculator.fact(11), DELTA);
    }
}
